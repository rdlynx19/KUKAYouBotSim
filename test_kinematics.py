...
wheel_joint_speeds = np.array([-10, 10, 10, -10, 0.5, 0, 0, 0.5, 0])

config_list = []

for i in range(0, 100):
    config_row = []
    updated_config = NextState(current_config=current_config, wheel_joint_speeds=wheel_joint_speeds, dt=0.01, speed_limit=5.0)
