...
simulated_configurations, error_variation = main(robot_params.Tb0, 
                                                ...
                                                robot_params.Tsc_initial_newTask,
                                                robot_params.Tsc_final_newTask,
...
np.savetxt("newTask_run.csv", simulated_configurations, delimiter=",")
print("Displaying error plot.")
np.savetxt("newTask_run_error.csv", error_variation, delimiter=",")
